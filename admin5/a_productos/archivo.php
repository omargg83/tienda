<?php
	...
	echo "<form autocomplete=off id='subir_File' action='' >";
		...
		echo "<div class='card-body' >";
			...
			echo "<div class='custom-file'>";
				echo "<input type='file' class='custom-file-input' id='precarga' required>";
		...
		echo "<div class='card-footer' >";
			echo "<div class='btn-group'>";
				echo "<button class='btn btn-outline-secondary btn-sm' type='submit' id='btnfile'><i class='far fa-save'></i>Procesar</button>";
