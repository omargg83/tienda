      ...
      <div class='card-footer'>
        <div class='btn-group'>
          ...
          <?php
            ...
            echo "<button type='button' class='btn btn-outline-secondary btn-sm' data-toggle='modal' data-target='#myModal' id='fileup_imagenx' data-ruta='a_imagenpagina/' data-tabla='baner2' data-campo='img' data-tipo='1' data-id='$id' data-keyt='id' data-destino='a_pagina/lista2' data-iddest='$id' data-ext='.jpg,.png' ><i class='fas fa-cloud-upload-alt'></i>Agregar imagen</button>";
