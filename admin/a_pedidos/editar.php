        ...
        echo "<div class='card-footer'>";
          echo "<div class='btn-group'>";
            echo "<button type='submit' class='btn btn-outline-secondary btn-sm'><i class='far fa-save'></i>Guardar</button>";
            	echo "<button type='button' class='btn btn-outline-secondary btn-sm' id='winmodal_pass' data-id='$idcliente' data-id2='$id' data-lugar='a_pedidos/form_cliente' title='Agregar cliennte' ><i class='fas fa-plus'></i>Cliente</button>";
              echo "<button type='button' class='btn btn-outline-secondary btn-sm' id='winmodal_pass' data-id='$idcliente' data-id2='$id' data-lugar='a_pedidos/form_producto' title='Agregar cliennte' ><i class='fas fa-plus'></i>Producto</button>";
