			...
			<div class="container reg">
				...
				<div class='row'>
					...
					<div class="col-4">
						...
						<input type="number" class="form-control input-number" id="cp" name='cp' placeholder="" value="" required>
					</div>
					<div class="col-4">
						<label>País</label>
					...
					<div class="col-4">
						...
						<input type="number" class="form-control input-number" id="telefono" name='telefono' placeholder="" value="" required>
					</div>
				</div>
				<hr>
				<div class="row">
